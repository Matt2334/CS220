...
#Assignment5: Evaluating and Ranking Functions
...
# [2] Define several different functions called f0, f1, f2, f3, etc. Let f0 be the Identity Function, i.e. f(n) = n. Let f1 thru f10 be the functions that appear in Slide 50 of Chapter 3.
